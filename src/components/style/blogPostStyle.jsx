...
export const LPItem = (props) => {
  return (
    <a
      ...
      } w-3/4 md:w-1/4 lg:w-3/10 mb-8 flex flex-col p-4 shadow-md hover:shadow-2xl rounded-xl transition duration-500 text-lg hover:bg-white group text-white hover:text-gray-100 transform hover:-translate-y-1`}
      style={{
        fontWeight: "600",
        background: `${
          props.Lab
